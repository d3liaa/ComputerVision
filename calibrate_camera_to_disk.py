...
def calibrate_camera_to_disk(root_config, max_frames=90, min_corners=12):
    # Estimate camera extrinsics in the disk/turntable frame.
...
def main():
    parser = argparse.ArgumentParser(description="Estimate camera extrinsics relative to the disk/turntable frame.")
    ...
    result = calibrate_camera_to_disk(root_config, max_frames=args.max_frames, min_corners=args.min_corners)
    dataset_name = root_config["active"]
